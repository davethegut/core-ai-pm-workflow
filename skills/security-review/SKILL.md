...
Write the review to: `output/reviews/security-review-{artifact-name}-{YYYY-MM-DD}.md`

Create the `output/reviews/` directory if it doesn't exist.
...
3. Read the first-pass security review at: output/reviews/security-review-{name}-{date}.md
4. Read the review checklist at: skills/security-review/references/review-checklist.md
5. Read the failure modes guide at: skills/security-review/references/common-failure-modes.md
